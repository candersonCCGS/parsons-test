...
## Another one
<div id="qn3-sortableTrash" class="sortable-code"></div> 
<div id="qn3-sortable" class="sortable-code"></div> 
<div style="clear:both;"></div> 
<p> 
    <input id="qn3-feedbackLink" value="Get Feedback" type="button" /> 
    <input id="qn3-newInstanceLink" value="Reset Problem" type="button" /> 
</p> 
...
(function(){
  ...
  var parsonsPuzzle = new ParsonsWidget({
    ...
    "lang": "en",
    "show_feedback": true,
    "trashId": "qn3-sortableTrash"
  });
  parsonsPuzzle.init(initial);
  parsonsPuzzle.shuffleLines();
  $("#qn3-newInstanceLink").click(function(event){ 
      event.preventDefault(); 
      parsonsPuzzle.shuffleLines(); 
  }); 
  $("#qn3-feedbackLink").click(function(event){ 
      event.preventDefault(); 
...
<div style="clear:both;"></div> 
<p> 
    <input id="qn1-feedbackLink" value="Get Feedback" type="button" /> 
    <input id="qn1-newInstanceLink" value="Reset Problem" type="button" /> 
</p> 
<script type="text/javascript"> 
(function(){
  var initial = "name = input(&#039;Enter a name: &#039;)\n" +
  ...
  parsonsPuzzle.init(initial);
  parsonsPuzzle.shuffleLines();
  $("#qn1-newInstanceLink").click(function(event){ 
      event.preventDefault(); 
      parsonsPuzzle.shuffleLines(); 
  }); 
  $("#qn1-feedbackLink").click(function(event){ 
      event.preventDefault(); 
      parsonsPuzzle.getFeedback(); 
  }); 
})(); 
